(function (root) {
  ...
  var STR = {
    pt: {
      ...
      aria_whatsapp: 'Copiar número para a área de transferência e abrir o WhatsApp',
      aria_email: 'Copiar e-mail para a área de transferência e abrir o app de e-mail',
      toast_copy_whatsapp_title: 'Número copiado',
      toast_copy_whatsapp_sub: 'Na área de transferência · abrindo o WhatsApp',
      toast_copy_email_title: 'E-mail copiado',
      toast_copy_email_sub: 'Na área de transferência · abrindo seu app de e-mail',
    ...
    en: {
      ...
      cta_email_sub: 'mystrader@gmail.com',
      aria_whatsapp: 'Copy number to clipboard and open WhatsApp',
      aria_email: 'Copy email to clipboard and open your mail app',
      toast_copy_whatsapp_title: 'Number copied',
      toast_copy_whatsapp_sub: 'On your clipboard · opening WhatsApp',
      toast_copy_email_title: 'Email copied',
      toast_copy_email_sub: 'On your clipboard · opening your mail app',
